(function() {
    ...
    try {
        ...
        console.log(`[InstagramWidget] 🚀 Инициализация виджета "${clientId}"`);
        ...
        loadConfig(clientId, baseUrl)
            .then(fetchedConfig => {
                ...
                console.log(`[InstagramWidget] ✅ Виджет "${clientId}" успешно создан`);
            })
            .catch(error => {
        ...
        const instagramPosts = [
            {
                ...
                content: 'There\'s something magical about that first sip of morning coffee. ☕ The rich aroma, the warmth of the cup in your hands... #coffee #morning',
            ...
            },
            {
                ...
                content: 'Golden hour vibes ✨ Nothing beats a perfect sunset after a long day. #sunset #photography #goldenhour',
            ...
            },
            {
                ...
                content: 'Street art discoveries in the city 🎨 Every corner tells a story. #streetart #urban #photography',
